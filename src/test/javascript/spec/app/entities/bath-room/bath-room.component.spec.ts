...
import { BathRoomComponent } from 'app/entities/bath-room/bath-room.component';
...
describe('Component Tests', () => {
  describe('BathRoom Management Component', () => {
    let comp: BathRoomComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BathRoomComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.bathRooms && comp.bathRooms[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

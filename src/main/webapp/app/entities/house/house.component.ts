...
export class HouseComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.houseService
      ...
      .subscribe(
        (res: HttpResponse<IHouse[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInHouses(): void {
    this.eventSubscriber = this.eventManager.subscribe('houseListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IHouse[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

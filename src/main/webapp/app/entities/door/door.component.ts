...
export class DoorComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.doorService
      ...
      .subscribe(
        (res: HttpResponse<IDoor[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInDoors(): void {
    this.eventSubscriber = this.eventManager.subscribe('doorListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IDoor[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

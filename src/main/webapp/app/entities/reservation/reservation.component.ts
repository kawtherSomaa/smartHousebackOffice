...
export class ReservationComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.reservationService
      ...
      .subscribe(
        (res: HttpResponse<IReservation[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInReservations(): void {
    this.eventSubscriber = this.eventManager.subscribe('reservationListModification', () => this.loadPage());
  }
